...
arithmetic roles is \emph{open}, and for the specific case of the Riemann $\zeta$ it has
been tested and found \emph{negative} (the certified $\zeta$-boundary of
\texttt{the-closure-object}).
\end{abstract}
